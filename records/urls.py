...
urlpatterns = [
    ...
    path("bowel/<int:pk>/delete/", views.bowel_record_delete_view, name="bowel_delete"),
    path("absence/<int:pk>/delete/", views.absence_record_delete_view, name="absence_delete"),
]